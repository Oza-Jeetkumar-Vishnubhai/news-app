...
export class News extends Component {
    ...
    // updateNews = async()=>{}
    async updateNews(){
        let url = `https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=dbb7035766c74f4fabe40e99bd4b816a&page=1&pageSize=6`;
    ...
    goToNext = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=dbb7035766c74f4fabe40e99bd4b816a&page=${this.state.page + 1}&pageSize=6`;
        let data = await fetch(url);
        let parsedData = await data.json();
        this.setState({
            articles: parsedData.articles,
    ...
    goToPrev = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=dbb7035766c74f4fabe40e99bd4b816a&page=${this.state.page - 1}&pageSize=5`;
        let data = await fetch(url);
        let parsedData = await data.json();
